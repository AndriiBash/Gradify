...
struct AcceptDeleteRowGrades: View
{
    @Binding var grade:                Grade
    @Binding var isShowSelfView:        Bool
    @Binding var isUpdateListGrades:    Bool
            ...
            VStack(spacing: 12)
            {
                ...
                VStack(spacing: 6)
                {
                    Button
                    {
                        Task
                        {
                            await writeModel.deleteGrade(withId: grade.id)
                            isUpdateListGrades.toggle()
