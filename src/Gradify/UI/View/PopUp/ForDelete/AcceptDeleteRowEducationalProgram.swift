//
//  AcceptDeleteRowEducationalProgram.swift
//  Gradify
//
...
struct AcceptDeleteRowEducationalProgram: View
{
    @Binding var educationalProgram:                EducationalProgram
    @Binding var isShowSelfView:                    Bool
    @Binding var isUpdateListEducationalProgram:    Bool
            ...
            VStack(spacing: 12)
            {
                ...
                VStack(spacing: 6)
                {
                    Button
                    {
                        Task
                        {
                            await writeModel.deleteEducationProgram(withId: educationalProgram.id)
                            isUpdateListEducationalProgram.toggle()
